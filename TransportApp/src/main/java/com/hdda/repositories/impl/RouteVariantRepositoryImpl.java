...
public class RouteVariantRepositoryImpl implements RouteVariantRepository {
    ...
    @Override
    public RouteVariant getDetailVariant(Long id) {
        Session s = factory.getObject().getCurrentSession();
        CriteriaBuilder cb = s.getCriteriaBuilder();
        CriteriaQuery<RouteVariant> cq = cb.createQuery(RouteVariant.class);

        Root<RouteVariant> r = cq.from(RouteVariant.class);
        r.fetch("startStop", JoinType.LEFT);
        r.fetch("endStop", JoinType.LEFT);
